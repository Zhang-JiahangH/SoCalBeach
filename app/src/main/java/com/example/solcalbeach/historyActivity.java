...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initView() {
        ...
        rl_head= (RelativeLayout) findViewById(R.id.history_rl_head);
        iv_head= (ImageView) findViewById(R.id.history_iv_head);
        tv_name= (TextView) findViewById(R.id.history_tv_name);
        tv_other= (TextView) findViewById(R.id.history_tv_other);
        ...
        usersRef.child(curUser.getUid()).child("name").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (!task.isSuccessful()) {
                    ...
                    tv_other.setText(String.valueOf(task.getResult().getValue()));
                }
            }
        });
