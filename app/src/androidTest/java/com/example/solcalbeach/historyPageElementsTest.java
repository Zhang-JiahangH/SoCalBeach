...
public class historyPageElementsTest {
    ...
    @Test
    public void historyPageElementsTest() throws InterruptedException {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvHistory), withText("Travel to: Bay Beach from 20-11-2022 13:41:35 to 20-11-2022 13:41:42"),
                        withParent(withParent(withId(R.id.history_lv))),
                        isDisplayed()));
